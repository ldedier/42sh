...
launch "hash"
	...
	test_launch 'hash ls; hash' 'unset PATH' 'hash'
	test_launch 'hash ls; hash' 'PATH=/bin' 'hash'
	test_launch 'hash ls; hash' 'export PATH=/' 'hash'
	test_launch 'hash ls; hash' 'export PATH' 'hash'
	test_launch 'hash ls; hash' 'export PATH=' 'hash'
	test_launch 'hash ls; hash' 'PATH=' 'hash'
	test_launch 'hash ls; hash' 'PATH="$PATH"' 'hash'
