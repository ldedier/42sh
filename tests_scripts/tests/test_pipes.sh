...
launch "Pipes"
	...
	launch "duplicating fd"
		test_launch "rm -f file" "./.fdwrite 1 okalm > file ; cat file | wc ; rm file"
		test_launch "rm -f file" "./.fdwrite 3 okalm 3>file ; cat file" "rm file"
		test_launch "rm -f file" "./.fdwrite 5 string 3>f3 4>f4 5>f5" "echo 3 ; cat f3" "echo 4 ; cat f4" "echo 5 ; cat f5" "rm f3 f4 f5"
		test_launch "rm -f file" "./.fdwrite 1 okalm 1>&- 1>&- 1>&2 1>&-"
		test_launch "rm -f file" "./.fdwrite 4 okalm 4>&- 4>&- 4>&1 4>&-"
		test_launch "rm -f file" "./.fdwrite 4 okalm 4>&1 4>&2 4>&3 3>file ; cat file ; rm file"
		test_launch "rm -f file" "./.fdwrite 4 okalm 4>&1 4>&2 3>file ; cat file ; rm file"
