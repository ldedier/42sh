...
/*   Updated: 2019/10/22 18:47:43 by mdaoud           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static t_job	*get_jobs_job(int num)
// {
// 	char	msg[100];
// 	t_job	*j;
// 	char	*str;
...
// 			ft_strcat(msg, str);
// 			free(str);
// 			sh_perror2("jobs", msg, "no such job");
// 		}
// 	}
// 	else if (num == 0)
// 	{
// 		j = job_get_by_sign('+');
// 		if (j == NULL)
// 			sh_perror2("jobs", msg, "no current job");
// 	}
// 	else if (num == -1)
// 	{
// 		j = job_get_by_sign('-');
// 		if (j == NULL)
// 			sh_perror2("jobs", msg, "no previous job");
// 	}
// 	return (j);
// }
