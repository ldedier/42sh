...
/*   Updated: 2019/10/08 19:30:12 by mdaoud           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** If we have a pipe seperator, we add a job (if it wasn't already added).
** Then we will fork, this fork will be the only process in the job.
** The we treat the fork as the only process in the job.
