...
/*   Updated: 2019/10/05 23:52:44 by mdaoud           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** sh_traverse_and_or_call_child_exec :
...
static int		sh_traverse_and_or_call_child_exec(t_ast_node *node,
	...
	t_context *context, int prev_symbol, t_list *ptr)
{
	...
	ret = sh_traverse_and_or_call_child_exec(child, &prev_symbol, context);
